...
| 날짜 | 내용 |
|------|------|
| 2026-04-19 | 🎚️ **Before/After 슬라이더** 추가 — 결과 카드 위에서 좌우 드래그로 원본 ↔ 변신 결과 즉시 비교 |
| 2026-04-19 | 💸 **예산 절감 모드** — 8개 자동 생성 → 사용자가 1~8개 직업 선택 (기본 1개) · '전체 선택/해제' 토글 + 선택 카운터 |
| 2026-04-19 | 🎨 글래스모피즘 + 오로라 디자인 (부스 메인과 통일) |
| 2026-04-19 | 초기 출시 (8가지 직업 동시 변환 + 13:10 인쇄용 카드 + ZIP 다운로드) |
